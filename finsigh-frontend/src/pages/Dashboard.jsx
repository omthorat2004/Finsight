  ...
  useEffect(() => {
    const fetchDashboard = async () => {
      try {
        ...
        if (
          Array.isArray(data.recent_feedbacks) &&
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-gray-600 mt-2'>
            Overview of customer feedback analytics
          </p>
        </div>
              ...
              <div className='relative w-40 h-40'>
                ...
                >
                  ...
                  <circle
                    ...
                    strokeWidth='12'
                    strokeDasharray={`${
                      (stats.positive / stats.total) * 251.2
                    } 251.2`}
                    strokeDashoffset='0'
                  ...
                  <circle
                    ...
                    strokeWidth='12'
                    strokeDasharray={`${
                      (stats.neutral / stats.total) * 251.2
                    } 251.2`}
                    strokeDashoffset={`-${
                      (stats.positive / stats.total) * 251.2
                    }`}
                  ...
                  <circle
                    ...
                    strokeWidth='12'
                    strokeDasharray={`${
                      (stats.negative / stats.total) * 251.2
                    } 251.2`}
                    strokeDashoffset={`-${
                      ((stats.positive + stats.neutral) / stats.total) * 251.2
                    }`}
                    className='transition-all duration-500'
                  />
                </svg>
                ...
                >
                  ...
                  <div className='flex items-center gap-3 text-xs'>
                    <span
                      ...
                      ${
                        feedback.category === 'Transaction Failure'
                          ? 'bg-red-100 text-red-700'
                          : feedback.category === 'App Crash'
                          ? 'bg-orange-100 text-orange-700'
                          : feedback.category === 'Fraud Alert'
